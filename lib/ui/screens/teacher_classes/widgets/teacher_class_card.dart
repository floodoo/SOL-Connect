  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Padding(
      ...
      child: GestureDetector(
        onTap: () async {
          try {
            log.d("Virtuelle Phasierung für schoolClass: " + schoolClass.displayName + " herunterladen ...");
            List<int> bytes =
                await ref.read(timeTableService).apiManager!.downloadVirtualSheet(klasseId: schoolClass.id);
