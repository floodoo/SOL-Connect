...
class UserSecureStorage {
  ...
  static Future setPhaseLoadDateStart(DateTime loadTime) async =>
      await _storage.write(key: _keyPhaseLoadBlockStart, value: loadTime.millisecondsSinceEpoch.toString());
  static Future setPhaseLoadDateEnd(DateTime endTime) async =>
      await _storage.write(key: _keyPhaseLoadBlockEnd, value: endTime.millisecondsSinceEpoch.toString());
